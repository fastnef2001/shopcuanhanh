...
<div><!--phần header-->
 ...
 <div id="maincontent"><!--phần bao của content-->
    <div id="content">
        <div class="dinhdang"><!--phần định dạng chung cho content và right-->
            ...
            <li class="zoom"><a href="#"><img src="img/aonu1.jpg"><span>Áo nữ làm for<br>(200.000đ)</span> </a></li>
            <li class="zoom"><a href="#"><img src="img/aonu2.jpg"><span>Áo nữ làm for<br>(200.000đ)</span> </a></li>
            <li class="zoom"><a href="#"><img src="img/aonu3.jpg"><span>Áo nữ làm for<br>(200.000đ)</span> </a></li>
           
            <li class="zoom"><a href="#"><img src="img/aonu4.jpg"><span>Áo nữ jeni<br>(200.000đ)</span> </a></li>
            <li class="zoom"><a href="#"><img src="img/aonu5.jpg"><span>Áo nữ jeni<br>(200.000đ)</span> </a></li>
            <li class="zoom"><a href="#"><img src="img/aonu6.jpg"><span>Áo nữ jeni<br>(200.000đ)</span> </a></li>
 ...
 <div id="right"><!--phần menu bên phải của website-->
    ...
    <h2>Khuyến mãi</h2>
        <div id="menuright">      
           <li class="zoom"><a href="#"><img src="img/kmaonu1.jpg"><span>Áo nữ thùy mị<br>(200.000đ)</span> </a></li> 
           <li class="zoom"><a href="#"><img src="img/kmaonu2.jpg"><span>Áo nữ thùy mị<br>(200.000đ)</span> </a></li> 
        </div>
