...
<div><!--phần header-->
 ...
 <div id="maincontent"><!--phần bao của content-->
    <div id="content">
        <div class="dinhdang"><!--phần định dạng chung cho content và right-->
            ...
            <li class="zoom"><a href="#"><img src="img/moinu1.jpg"><span>Bộ đồ mới 1<br>(200.000đ)</span></a></li>
            <li class="zoom"><a href="#"><img src="img/moinu2.jpg"><span>Bộ đồ mới 1<br>(200.000đ)</span></a></li>
            <li class="zoom"><a href="#"><img src="img/moinu3.jpg"><span>Bộ đồ mới 1<br>(200.000đ)</span></a></li>
            <li class="zoom"><a href="#"><img src="img/moinu4.jpg"><span>Bộ đồ mới 2<br>(200.000đ)</span></a></li>
            <li class="zoom"><a href="#"><img src="img/moinu5.jpg"><span>Bộ đồ mới 2<br>(200.000đ)</span></a></li>
            <li class="zoom"><a href="#"><img src="img/moinu6.jpg"><span>Bộ đồ mới 2<br>(200.000đ)</span></a></li>
 ...
 <div id="right"><!--phần menu bên phải của website-->
    ...
    <h2>Khuyến mãi</h2>
        <div id="menuright">
        <li class="zoom"><a href="#"><img src="img/1.jpg"><span>Bộ đồ ngầu vãi <br>(200.000đ)</span></a></li>
        <li class="zoom"><a href="#"><img src="img/2.jpg"><span>Bộ đồ đĩ vãi 2<br>(200.000đ)</span></a></li>
